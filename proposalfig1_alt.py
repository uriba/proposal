...
fig.subplots_adjust(right=0.9,wspace=0.35,hspace=0.3)
a = subplot(311)
...
lns = ln1+ln2+ln3
legend(lns,[l.get_label() for l in lns],prop={'size':axisfontsize},loc="upper left")
set_ticks(ax)
...
a2.set_ylabel("Protein Acc. rate per OD [au]",fontsize=axisfontsize)
